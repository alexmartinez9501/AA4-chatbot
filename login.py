...
titulo = Label(root, text="Login",font=("Calisto",36,"bold"))
...
username_label = Label(root, text="Usuario:",font=("Arial",15,"bold") )
username_label.pack()
username_entry = tk.Entry(root, font="Arial")
username_entry.pack(pady=20)

password_label = Label(root, text="Contraseña:",font=("Arial",15,"bold"))
password_label.pack()
password_entry = tk.Entry(root, show="*")
password_entry.pack(pady=20)

# Create a login button
login_button = tk.Button(root, text="Login",cursor="hand2",width=16,command=authenticate_user)
login_button.pack()
